...
import {CreditCard, Store, Users2} from 'lucide-react'
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink className={'flex flex-row items-center gap-2'} to="/">
          <img src={Logo} className='w-20 rounded-xl drop-shadow-xl shadow-xl  h-20' alt="Logo" />
          <h1 className='text-xl text-white  drop-shadow-xl shadow-xl '>Prive Pay</h1>
        </NavLink>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/merchants"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('merchants') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <Store />
              ...
              <li>
                <NavLink
                  to="/withdraws"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('withdraws') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <CreditCard />
