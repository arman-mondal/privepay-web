...
const SignIn: React.FC = () => {
  ...
  const handlesubmit=async (e:any)=>{
    ...
    try {
      ...
      if (data.email === 'armanm@fht.co.in' || data.password === 'Arman#821') {
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 flex-row  flex items-center justify-center gap-2 " to="/">
              <img src={Logo} className='w-20 hidden rounded-xl drop-shadow-xl shadow-xl  h-20' alt="Logo" />
              <img className="dark:hidden w-40 rounded-xl "  src={LogoDark} alt="Logo" />

          <h1 className='text-3xl  font-bold text-black  '>Prive Pay</h1>
              </Link>
              ...
              <span className="mt-15 inline-block">
                ...
                >
                  ...
                  />
                  <path
                    d="M62.8332 281.679L66.4705 269.714C62.9973 264.921 59.2562 2p0?: stringp0: string60.327 55.2652 255.954L52.019 260.576L53.8812 254.45C48.8923 249.092 45.2489 245.86 45.2489 245.86C45.2489 245.86 38.0686 270.253 39.9627 293.358L52.0658 303.903L40.6299 299.072C41.0301 301.712 41.596 304.324 42.3243 306.893C49.7535 332.77 64.2336 351.323 74.6663 348.332C85.0989 345.341 87.534 321.939 80.1048 296.063C77.8019 288.041 73.5758 280.169 68.8419 273.123L62.8332 281.679Z"
                    fill="#F2F2F2"
                  />
                  <path
